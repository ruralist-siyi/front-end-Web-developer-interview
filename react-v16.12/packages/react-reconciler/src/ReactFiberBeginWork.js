...
function beginWork(
  ...
  if (current !== null) {
    ...
    if (
      ...
      // 并非初次渲染，判断是否 props 有变化或 context 有变化，如果有变化则将 didReceiveUpdate 设置为 true
      // If props or context changed, mark the fiber as having performed work.
      // This may be unset if the props are determined to be equal later (memo).
      didReceiveUpdate = true;
    } else if (updateExpirationTime < renderExpirationTime) { // 判断workInProgress 的 expirationTime 是否小于传入的 expirationTime
      didReceiveUpdate = false;

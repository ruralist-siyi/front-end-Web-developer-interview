...
export function updateContainer(
  element: ReactNodeList, // 根组件<APP />
  container: OpaqueRoot, // fiberRoot
  parentComponent: ?React$Component<any, any>, // render是null
  callback: ?Function,
): ExpirationTime {
  if (__DEV__) {
  ...
  // 如果是同步模式直接返回Sync，如果conCrrent模式，那就需要优先级确定expirationTime
  ...
  // 开始任务调度（ ReactDOM.render, setState，forceUpdate, React Hooks的dispatchAction都要经过scheduleWork。）
